...
const Header = () => {
  ...
  useEffect(() => {
    // Use localStorage as a cookie for each user's darkMode settings.
      ...
      <nav className="bg-white border-b-2 border-gray-200 dark:bg-gray-900 dark:border-b-1 dark:border-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
              <img src={ Logo } className="mr-2 h-6 sm:h-9" alt="Cinespot Logo" />
              <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Cinespot</span>
          </Link>
          ...
          <div id="mobile nav" className="flex md:order-2">
            ...
            {/* Search Button - toggles the navigation menu*/}
            ...
            {/* Search Button - toggles the search area and navigation menu*/}
            ...
            {/* Menu Icon/Button - toggles the search area and navigation menu*/}
          ...
          {/* Navigation Area - toggles the navigation menu depends on device*/}
          <div className={`items-center justify-between ${hidden ? "hidden" : ""} w-full md:flex md:w-auto md:order-1`} id="navbar-search">
            
            {/* If smaller devices, everything in this div will not show. i.e search bar */}
            ...
            {/* This nav menu will change depending on the size of the screen */}
